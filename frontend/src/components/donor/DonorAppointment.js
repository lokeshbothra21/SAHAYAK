...
class DonorAppointment extends Component {
  constructor(props) {
    ...
    this.organsHandler = this.organsHandler.bind(this);
  ...
  organsHandler=(event)=>{
    ...
    const newErrors={};
    console.log(event.target.value);
    const organs= event.target.value;
    this.organsValidation(newErrors,organs)
  }
  organsValidation = (newErrors, organs) => {
    let flag = true;
    if (organs === '') {
      newErrors.organs = ' Cannot be blank!'
      flag = false;
    }
  ...
  handleSubmit = (event) => {
    ...
    if (Object.keys(newErrors).length > 0) {
      ...
      const { firstName, lastName, birthDate, organs,gender, email, stateId, districtId, cityId, mobile, password, confirmPassword } = this.state;
      console.log(cityId);
      const city = {
        "id": cityId
      }
      const donor = { firstName, lastName, birthDate,organs, gender, email, city, mobile, password }
      console.log(donor);
  ...
  render() {
    ...
    const {
      isValidFirstName, isValidLastName, isValidBirthDate, isValidOrgans,isValidGender,
      ...
      <div className="container bg-dark text-white text-center col-9 font-weight-bold">
        ...
        <Form noValidate onSubmit={this.handleSubmit}>
          ...
          <div className="row">
            ...
            <div className="col-md-4 ">
              <Form.Group className='m-2' controlId="formGridOrgans" >
                <Form.Label >Organs</Form.Label>
                <Form.Select className="col" name="organs" onChange={this.organsHandler}
                  isValid={isValidOrgans} isInvalid={!!errors.organs} required>
                  <option value="-1" hidden>Choose Value</option>
                ...
                <Form.Control.Feedback ><b>Looks good!</b></Form.Control.Feedback>
                <Form.Control.Feedback type="invalid"><b>{errors.organs}</b></Form.Control.Feedback>
              </Form.Group>
            </div>
